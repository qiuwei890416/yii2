        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form"  id="art_form" enctype="multipart/form-data">
                        ...
                        <div class="layui-input-inline">
                            <select name="cate_id" lay-verify="required">
                                <?php foreach($list as $key=>$val){ ?>
                                    <?php if($val['id']==$data['cate_id']){ ?>
                                        <option selected value="<?= $val['id']; ?>"><?= str_repeat('|----',$val['level']); ?><?= $val['cate_name']; ?></option>
                                    <?php }else{ ?>
                    ...
                    <?php if(isset($data['art_thumb'])&&$data['art_thumb']!=''){ ?>
                    <div class="layui-form-item layui-form-text" id="tuxian" >
                        <label class="layui-form-label"></label>
                        <div class="layui-input-block">
                            <img id="old" src="<?php echo \Yii::$app->request->hostInfo.'/'; ?><?= $data['art_thumb']; ?>" style="width: 90px;"/>
                            <img id="imgshow" src="" alt="" style="width: 90px;display: none;"/>
                        </div>
                    </div>
                    <?php }else{ ?>
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block layui-upload">
                            ...
                            <input id="filed" type="file" name="Article[thumb]" id="filed" style="display: none;" accept="image/*">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item layui-form-text zhanshi">
                        ...
                        <div class="layui-input-block layui-upload zst">
                            ...
                            <div id="thumb_display" >
                                <?php
                                    if(isset($data['thumball'])&&$data['thumball']!=''){
                                        foreach($data['thumball'] as $key=>$val){ ?>
                                        <span style="margin:5px;float: left;">
                                    <img src="<?php echo \Yii::$app->request->hostInfo.'/'; ?><?= $val; ?>" height="60" width="60">
                                    <input type="hidden" name="thumball[]" value="<?= $val; ?>" >
                                    <br>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="radio" name="art_status" value="1"<?php if($data['art_status']==1){ ?> checked<?php } ?> title="是">
                            <input type="radio" name="art_status" value="2"<?php if($data['art_status']==2){ ?> checked<?php } ?> title="否" >
                        </div>
                    </div>
                ...
                $('#test1').on("click", function() {
                    ...
                    $('#filed').change(function(){
                        ...
                        reader.onload=function(e){
                            ...
                            //的base64编码格式的地址
                            $('#imgshow').attr('style','display:block;width: 90px;');
