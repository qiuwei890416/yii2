                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="cate_type" lay-verify="required">
                                <option <?php if($data['cate_type']==1){ ?> selected <?php } ?> value="1">文章列表</option>
                                <option <?php if($data['cate_type']==2){ ?> selected <?php } ?>  value="2">单页</option>
                                <option <?php if($data['cate_type']==3){ ?> selected <?php } ?> value="3">图片列表</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
