    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('用户列表','<?= Url::to(['user/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite></a>
                    </li>
                    <!--{{&#45;&#45;                    <li>&#45;&#45;}}-->
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="角色&权限">&#xe6ae;</i>
                    <cite>角色&权限</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('权限分组标题','<?= Url::to(['fz/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限分组标题</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('角色管理','<?= Url::to(['authgroup/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>角色管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('权限管理','<?= Url::to(['authrule/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限管理</cite></a>
                    </li>
                    <!--                    {{&#45;&#45;                    <li>&#45;&#45;}}-->
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('分类列表','<?= Url::to(['category/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>分类列表</cite></a>
                    </li>
                    <!--                    {{&#45;&#45;                    <li>&#45;&#45;}}-->
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('文章列表','<?= Url::to(['article/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文章列表</cite></a>
                    </li>
                    <!--                    {{&#45;&#45;                    <li>&#45;&#45;}}-->
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('配置列表','<?= Url::to(['config/index']) ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>配置列表</cite></a>
                    </li>
                    <!--                    {{&#45;&#45;                    <li>&#45;&#45;}}-->
